...
function Contacts(props) {
    ...
    const [mapDimensions, setMapDimensions] = useState({ width: '80vh', height: '70vh' });

    const updateMapDimensions = () => {
        if (window.innerWidth <= 950) {
            setMapDimensions({ width: '100%', height: '50vh' });
        } else {
            setMapDimensions({ width: '80vh', height: '70vh' });
        }
    };
            ...
            <div className={styles.contacts}>
                ...
                <div className={styles["our-location"]}>
                    <div className={styles["our-location__header"]}>
                        ...
                        <h2>Мы находимся</h2>
                        <p>FillSwift здесь, чтобы обслуживать вас в разных местах. Если вы хотите встретиться с нашей командой, обсудить возможности сотрудничества или просто зайти поболтать, у нас есть офис, удобно расположенный для удовлетворения ваших потребностей. Изучите категории ниже, чтобы найти офис FillSwift.</p>
                    </div>
                    <div className={styles["our-location__main"]}>
                        ...
                        <div className={styles["our-location__info"]}>
                            <article>
                                ...
                                <p>Наша главная штаб-квартира, расположенная в оживленном центре города, именно здесь работает наша основная команда экспертов, стремящихся к совершенству и инновациям, которые нас определяют.</p>
                            </article>
                            ...
                            <div className={styles["redirection"]}>
                                <button>
                                    <a href="https://yandex.ru/maps/24/veliky-novgorod/?indoorLevel=1&ll=31.244554%2C58.543980&mode=routes&rtext=~58.543946%2C31.244149&rtt=auto&ruri=~&z=17.12" target="_blank" rel="noopener noreferrer">Получить направление</a>
                                </button>
                            </div>
                        </div>
                    </div>
